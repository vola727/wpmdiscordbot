...
2. **Install dependencies:**
   ...
   ```
   *(Note: You may need to create a requirements.txt using `pip freeze > requirements.txt` if one isn't present)*
...
This project is open source. You can modify and distribute it as you see fit.
